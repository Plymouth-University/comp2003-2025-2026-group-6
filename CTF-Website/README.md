# Capture the Flag – Working UI Prototype

This is a Semester 1 prototype demonstrating how a Figma UI design
was translated into a working web-based game prototype.

## Features
- HTML/CSS UI based on Figma layout
- Playable game area using JavaScript
